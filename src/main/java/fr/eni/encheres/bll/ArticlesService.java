...
public interface ArticlesService {
	...
	List<Article> ConsulterArticlesByIdVenteNonDebuteeAndCategorieAndNomArticle(int idVendeur, int idCategorie,
			String mot);

	List<Article> ConsulterArticlesByIdVenteTermineeAndCategorieAndNomArticle(int idVendeur, int idCategorie,
			String mot);
	...
	List<Article> ConsulterArticlesByIdVendeurAyantRemporteAndCategorieAndNomArticle(int idVendeur, int idCategorie,
			String mot);
